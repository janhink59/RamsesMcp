/*
	...
	Popis:   Použije se v pøípadì, že se uživatel chce pøihlásit k jiné organizaci.
	         Zpracovává volný text pomocí hybridní heuristiky a vrací více sad výsledkù.
*/
...
BEGIN
	...
	-- 1. Zjištìní aktuálního uživatele z dbsession
	...
	BEGIN
		SELECT 'Status' AS __block_name, 'Chyba' AS Status, 'Nelze identifikovat pøihlášeného uživatele pro aktuální SPID.' AS Message;
		RETURN;
	END
	...
	-- 3. Vyèištìní balastu (skóre < 0.15 znamená, že to vùbec nesedí)
	...
	-- 4. Výbìr pouze organizací se sdíleným nejlepším skóre
	...
	BEGIN
		-- ==============================================================================
		-- Nalezeno VÍCE kandidátù (Ambiguita) -> Vracíme vícenásobný result-set (Multi-RS)
		-- ==============================================================================
		...
		SELECT 
			...
			'Více shod' AS Status,
			'Nalezeno více možností. Vyžádejte si od uživatele upøesnìní z pøiložené tabulky organizací.' AS Message;
