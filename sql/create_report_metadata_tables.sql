...
-- * Slouží jako zdroj pravdy pro flexible_report.php, který na základì zde definovaných
-- * datových typù provádí striktní typovou kontrolu (Type Casting) pøedaných parametrù.
-- *
