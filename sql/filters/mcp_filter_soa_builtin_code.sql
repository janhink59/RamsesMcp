...
BEGIN
	...
	BEGIN
		...
		SELECT 
			'Status' AS __block_name,
			'Více shod' AS Status,
			'Bylo nalezeno více možností. Přečti si následující tabulku: Pokud z kontextu chatu vyhodnotíš jednoznačného favorita, ulož jeho hodnotu [Kód předpisu] ručně voláním set_context_variable. Pokud váháš, požádej uživatele o upřesnění.' AS Message;
